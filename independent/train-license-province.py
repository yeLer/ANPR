...
SAVER_DIR = "../data/output/train-saver/province/"

PROVINCES = ("京", "闽", "粤", "苏", "沪", "浙")
PROVINCES_DICT = {1:"京",2:"闽", 3:"粤", 4:"苏", 5:"沪", 6:"浙"}
nProvinceIndex = 0
...
if __name__ == '__main__' and sys.argv[1] == 'train':
    ...
    for i in range(0, NUM_CLASSES):
        dir = '../data/license_plate_dt_v1/train_images/training-set/chinese-characters/%s/' % i  # 这里可以改成你自己的图片目录，i为分类标签
    ...
    val_count = 0
    for i in range(0, NUM_CLASSES):
        dir = '../data/license_plate_dt_v1/train_images/validation-set/chinese-characters/%s/' % i  # 这里可以改成你自己的图片目录，i为分类标签
        for rt, dirs, files in os.walk(dir):
            for filename in files:
                val_count += 1
...
if __name__ == '__main__' and sys.argv[1] == 'predict':
    ...
    with tf.Session() as sess:
        ...
        path = "../data/license_plate_dt_v1/test_images/provinces"
